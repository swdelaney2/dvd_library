...
// '<form action="/movies" method="post"><input type="hidden" name="authenticity_token" value="<%= form_authenticity_token %>"><input type="hidden" name="movie[imdbID]" id="movie[imdbID]" value="' + data.Search[i].imdbID + '"><input type="submit" name="commit" value="Add Movie"/></form>'
